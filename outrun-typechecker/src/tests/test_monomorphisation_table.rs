...
use crate::dispatch::{FunctionInfo, FunctionVisibility, MonomorphisationEntry, MonomorphisationTable};
...
fn test_multiple_instantiations_same_function() {
    ...
    int_substitutions.insert("T".to_string(), Type::Concrete {
        id: TypeId::new("Integer64"),
        args: vec![],
        span: None,
    });
    ...
    let int_entry = MonomorphisationEntry {
        ...
        monomorphised_function: MonomorphisationTable::create_monomorphised_function(
            &generic_function,
            &HashMap::from([("T".to_string(), Type::Concrete {
                id: TypeId::new("Integer64"),
                args: vec![],
                span: None,
            })]),
    ...
    string_substitutions.insert("T".to_string(), Type::Concrete {
        id: TypeId::new("String"),
        args: vec![],
        span: None,
    });
    ...
    let keys: Vec<String> = instantiations.iter()
...
fn test_type_substitution_in_complex_types() {
    ...
    let generic_function = FunctionInfo {
        ...
        visibility: FunctionVisibility::Public,
        parameters: vec![
            ("key".to_string(), Type::Concrete {
                id: TypeId::new("K"),
                args: vec![],
                span: None,
            }),
            ("values".to_string(), Type::Concrete {
                id: TypeId::new("List"),
                args: vec![Type::Concrete {
                    id: TypeId::new("V"),
                    args: vec![],
    ...
    substitutions.insert("K".to_string(), Type::Concrete {
        id: TypeId::new("String"),
        args: vec![],
        span: None,
    });
    substitutions.insert("V".to_string(), Type::Concrete {
        id: TypeId::new("Integer64"),
        args: vec![],
        span: None,
    });
...
fn test_all_entries_iteration() {
    ...
    for type_name in &["Integer64", "String", "Boolean"] {
        let mut substitutions = HashMap::new();
        substitutions.insert("T".to_string(), Type::Concrete {
    ...
    let keys: Vec<String> = all_entries.iter()
        .map(|(key, _)| (*key).clone())
        .collect();
