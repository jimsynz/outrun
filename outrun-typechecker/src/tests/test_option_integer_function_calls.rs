...
fn test_function_with_option_integer_parameter() {
    ...
    engine.protocol_registry_mut().add_local_module(crate::types::ModuleId::new("Outrun.Core.Integer64"));
    engine.protocol_registry_mut().add_local_module(crate::types::ModuleId::new("Outrun.Core.Boolean"));
    engine.protocol_registry_mut().add_local_module(crate::types::ModuleId::new("Integer"));
    engine.protocol_registry_mut().add_local_module(crate::types::ModuleId::new("Boolean"));
    engine.protocol_registry_mut().add_local_module(crate::types::ModuleId::new("Option"));
    engine.protocol_registry_mut().add_local_module(crate::types::ModuleId::new("TestModule"));
...
fn test_function_call_with_protocol_constraint_in_generics() {
    ...
    // Set up local modules  
    engine.protocol_registry_mut().add_local_module(crate::types::ModuleId::new("Outrun.Core.Integer64"));
    engine.protocol_registry_mut().add_local_module(crate::types::ModuleId::new("Outrun.Core.String"));
    engine.protocol_registry_mut().add_local_module(crate::types::ModuleId::new("Integer"));
    engine.protocol_registry_mut().add_local_module(crate::types::ModuleId::new("String"));
    engine.protocol_registry_mut().add_local_module(crate::types::ModuleId::new("Option"));
    engine.protocol_registry_mut().add_local_module(crate::types::ModuleId::new("Result"));
    engine.protocol_registry_mut().add_local_module(crate::types::ModuleId::new("TestModule"));
...
"#;
    ...
    match result {
        ...
        Err(e) => {
            println!("✅ Correctly rejected Option<String> for Option<Integer>: {:?}", e);
        }
    }
}