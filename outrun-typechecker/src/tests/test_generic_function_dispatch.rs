...
use crate::dispatch::{
    DispatchResult, FunctionDispatcher, FunctionInfo, FunctionRegistry, FunctionVisibility,
...
fn test_resolve_generic_call_with_monomorphisation() {
    ...
    let result = dispatcher
        .resolve_generic_call("Wrapper", "wrap", &[&int_type], None)
        .unwrap();
...
fn test_resolve_generic_call_different_types() {
    ...
    let result = dispatcher
        .resolve_generic_call("Wrapper", "wrap", &[&string_type], None)
        .unwrap();
...
fn test_resolve_qualified_call_with_types() {
    ...
    let result = dispatcher
        .resolve_qualified_call_with_types("Wrapper.wrap", &[&int_type], None, None)
        .unwrap();
...
fn test_resolve_qualified_call_without_types_fallback() {
    ...
    let result = dispatcher
        .resolve_qualified_call_with_types(
            "Utils.identity",
            &[], // No type arguments
            None,
            None,
...
fn test_resolve_generic_call_nonexistent_monomorphisation() {
    ...
    let result = dispatcher
        .resolve_generic_call("Wrapper", "wrap", &[&boolean_type], None)
        .unwrap();
...
fn test_resolve_generic_call_nonexistent_function() {
    ...
    let result = dispatcher.resolve_generic_call("NonExistent", "missing", &[&int_type], None);
